...
`cmpfs`'s fixtures are captured rather than collected, on a Mac. See
`cmpfs/docs/FIXTURES.md` for the layout, the capture approach, and what a
current macOS can and cannot produce.
